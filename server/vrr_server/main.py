...
async def setup_frame_sending(width, height):
    ffmpeg_params = "-vaapi_device /dev/dri/renderD128 -vf 'format=nv12,hwupload' -c:v h264_vaapi -rc_mode CQP -pix_fmt yuv444p10le -preset fast -tune zerolatency -crf 18 -maxrate 20M -bufsize 40M"
    ffmpeg_cmdlines = (
