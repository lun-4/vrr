...
async def setup_frame_sending(width, height):
    ffmpeg_params = "-vaapi_device /dev/dri/renderD128 -vf 'format=nv12,hwupload' -c:v h264_vaapi -rc_mode CQP -qp 30 -pix_fmt yuv444p10le -preset fast -tune zerolatency -crf 18 -minrate 100M -maxrate 200M -bufsize 200M"
    ffmpeg_cmdlines = (
